    ...
    <div class="el-toolbar">
      <div class="el-toolbar-body" style="justify-content: flex-start;">
       <el-button type="text" @click="exportData" ><i class="fa fa-plus" /> 导出</el-button>
        <el-button type="text" @click="importData" disabled="true"><i class="fa fa-plus" /> 导入</el-button>
      </div>
    </div>
      ...
      <el-form label-position="right" label-width="170px">
        ...
        <el-form-item label="文件">
          <el-upload
            ...
            :action="'http://localhost:8102/admin/base/dict/importData'"
            class="upload-demo">
...
export default {
  ...
  methods: {
    ...
    exportData() {
      window.location.href = 'http://localhost:8102/admin/base/dict/exportData'
    },
